...
class ViewPagerAdapter(private var itemList: ArrayList<Int>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PagerViewHolder {
        val binding = SyncListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class PagerViewHolder(private val binding: SyncListItemBinding) : RecyclerView.ViewHolder(binding.root) {
